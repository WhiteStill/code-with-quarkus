...
const CHAMPIONS = [
    ...
    { name: '징크스', engName: 'Jinx', role: '원거리딜러', lane: '미드', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Jinx.png', difficulty: '중'},
    { name: '멜', engName: 'Mel', role: '마법사', lane: '바텀', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Mel.png', difficulty: '중'},
    { name: '유나라', engName: 'Yunara', role: '원거리딜러', lane: '바텀', img: 'https://ddragon.leagueoflegends.com/cdn/15.24.1/img/champion/Yunara.png', difficulty: '중'},
];
...
function performSearch(query) {
    ...
    // [추가된 조건] 검색어가 없거나 공백인 경우 메인 화면으로 돌아가기
    if (!q) {
        showMainScreen();
        return;
    }

    document.getElementById('searchKeywordDisplay').textContent = `"${query}"`; // 검색어 표시
